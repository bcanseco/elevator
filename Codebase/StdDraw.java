 ...
 *  <li> {@link #text1(double x, double y, String text, double degrees)}
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static void text1(double x, double y, String text, double scale, boolean bool) {
        if (bool) {
            if (text == null) throw new NullPointerException();
            offscreen.setFont(new Font("TimesRoman", Font.PLAIN, (int) (50/(scale*2.0))));
            FontMetrics metrics = offscreen.getFontMetrics();
            double xs = scaleX(x);
            double ys = scaleY(y);
            int ws = metrics.stringWidth(text);
            ...
            if (text == null) throw new NullPointerException();
            offscreen.setFont(new Font("TimesRoman", Font.PLAIN, (int) (50/scale)));
            FontMetrics metrics = offscreen.getFontMetrics();
            double xs = scaleX(x);
            double ys = scaleY(y);
            int ws = metrics.stringWidth(text);
